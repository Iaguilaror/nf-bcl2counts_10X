...
input_dir <- "test/data/260_CRO_WTA_tonsil_cellrangercounts/"  # "test/data/test_sample_cellrangercounts/"

# Leemos la data1
cellranger.data <- Read10X( data.dir = paste0( input_dir, "/outs/filtered_feature_bc_matrix") )
